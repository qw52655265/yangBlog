...
Showbo.Msg={  
    ...
    InitMsg:function(width){  
      ...
      html='<div class="top"><div class="right"><div class="title" id="dvMsgTitle"></div></div></div>'+  
        ...
        '<div class="bottom" id="dvMsgBottom"><div class="right"><div class="btn2" id="dvMsgBtns"></div></div></div>';  
    ...
    createBtn:function(p,v,fn){  
        ...
        btn.onmouseout=function(){this.className='btn2';}  
    ...
    onResize:function(isResize){  
       ...
       Showbo.Msg.dvMsgBox.style.top=(document.body.scrollTop+240)+'px';  
