				...
				<nav id="site-nav" class="main-nav">
					...
					<div class="">
						<ul id="" class="down-menu nav-menu sf-js-enabled sf-arrows">
							<li id="menu-item-2" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-2"><a href="<%=basePath %>/index.do"><i class="fa-home fa"></i><span class="font-text">首页</span></a></li>
...
<!-- 								</ul> -->
<!-- 							</li> -->
							<li id="menu-item-90" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-90"><a href="<%=basePath%>/getBlogList/all/all.do"><i class="fa-folder-open fa"></i><span class="font-text">文章</span></a></li>
<!-- 							<li id="menu-item-54" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-54"><a href="javascript:void(0)"><i class="fa-book fa"></i><span class="font-text">微语</span></a></li> -->
							<li id="menu-item-91" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-91"><a href="<%=basePath%>/getAlbum.do"><i class="fa-camera-retro fa"></i><span class="font-text">相册</span></a></li>
