...
<body class="page-template page-template-pages page-template-template-album page-template-pagestemplate-album-php page page-id-14">
	<div id="page" class="hfeed site">
		...
		<nav class="breadcrumb">
			...
			<i class="fa fa-angle-right"></i><a href="<%=basePath%>/getAlbum.do" rel="category tag">相册</a>
										...
										<c:forEach items="${list.row }" var="c" varStatus="v">
											<div id="ngg-image-2" class="ngg-gallery-thumbnail-box">
												<div class="ngg-gallery-thumbnail">
													<a href="<%=basePath%>/${c.url}" title=" " class="fancybox" data-fancybox-group="button" 14="">
														<img title="${c.name }" alt="${c.name }" src="<%=basePath%>/${c.url}" width="148" height="148">
													</a>
												</div>
											</div>
										</c:forEach>
